...
int main()
{
   ...
   /* test getMinimum */
   cout << "Testing getMinimum: " << providedTree.getMinimum() << endl;

   /* test getMaxmimum */
   cout << "Testing getMaximum: " << providedTree.getMaximum() << endl;
   ...
   cout << endl; // blank line
    ...
    /* test getMinimum */
   cout << "Testing getMinimum: " << copiedProvidedTree.getMinimum() << endl;

    /* test getMaxmimum */
   cout << "Testing getMaximum: " << copiedProvidedTree.getMaximum() << endl;
   ...
   cout << "Filling randomTree with random ints from 1 to 2000, size of 20\n";
   for ( int i = 0; i < RANDOM_SIZE; ++i){
      randomTree.insert(rand()%2000+1);
   }

   /* test displayGraphic() */
  cout << "\nTesting displayGraphic for randomTree after it is filled\n";
  randomTree.displayGraphic(cout);
  cout << endl; // blank line

   /* test getMinimum */
  cout << "Testing getMinimum: " << randomTree.getMinimum() << endl;
   /* test getMaxmimum */
  cout << "Testing getMaximum: " << randomTree.getMaximum() << endl;
   /*test getHeight */
  cout << "Testing getHeight: " << randomTree.getHeight() << endl;
   /* test getSize */
  cout << "Testing getSize: " << randomTree.getSize() << endl;
   /* testing inorder traversal */
  cout << "Inorder traversal: ";
  randomTree.inorder(cout);
  cout << endl;
  ...
  randomTree.displayGraphic(cout);
   ...
   /***************************************************************************
    * Testing Character Tree with a fixed tree of characters
    * *************************************************************************
    */


   BinarySearchTree<char> charTree;
   BinarySearchTree<char> copiedCharTree;

   //test charTree before it is filled
   cout << "------------------------------------------------------------\n";
   cout << "Testing charTree before it is filled.  It should be empty. \n";
   cout << "getMaximum: " << charTree.getMaximum() << endl;
   cout << "getMinimum: " << charTree.getMinimum() << endl;
   cout << "getHeight: " << charTree.getHeight() << endl;
   cout << "getSize: " << charTree.getSize() << endl;
   cout << "inorder: " << endl;
   charTree.inorder(cout);
   cout << "preorder: " << endl;
   charTree.preorder(cout);
   cout << "postorder: " << endl;
   charTree.postorder(cout);
   cout << endl;  //blank line

    //display the graphic for charTree
   cout << "Displaying the Graphic for charTree: \n";
   charTree.displayGraphic(cout);

    //copy charTree to copiedCharTree and display the graphic
   cout << "\nCopying charTree to copiedDoubleTree and displaying: " << endl;
   copiedCharTree = charTree;
   copiedCharTree.displayGraphic(cout);

   //fill charTree with characters
   charTree.insert('M');
   charTree.insert('A');
   charTree.insert('T');
   charTree.insert('T');
   ...
   //Test charTree after it is filled
   cout << "Testing charTree after it is filled.  It should be empty. \n";
   cout << "getMaximum: " << charTree.getMaximum() << endl;
   cout << "getMinimum: " << charTree.getMinimum() << endl;
   cout << "getHeight: " << charTree.getHeight() << endl;
   cout << "getSize: " << charTree.getSize() << endl;
   ...
   //copy charTree to copiedCharTree and display the graphic
   cout << "\nCopying charTree to copiedCharTree and displaying: " << endl;
   copiedCharTree = charTree;
   copiedCharTree.displayGraphic(cout);
   ...
   //Search for the letter A in the charTree variable
   cout << "Testing search function.  Find A: " << endl;
   if (charTree.search('A')){
      cout << "A!\n";
   }
   else {
      cout << "Not found. :(\n";
   }
   //Search for the letter P in the charTree variable
   cout << "Now find P: " << endl;
   if (charTree.search('P')){
      cout << "Found P!\n";
   }
   else {
      cout << "Not found. :(\n";
   ...
   /***************************************************************************
    * Testing String Tree with a fixed tree of strings
    * *************************************************************************
    */


   BinarySearchTree<string> stringTree;
   BinarySearchTree<string> copiedStringTree;

   //test stringTree before it is filled
   cout << "------------------------------------------------------------\n";
   cout << "Testing stringTree before it is filled.  It should be empty. \n";
   cout << "getMaximum: " << stringTree.getMaximum() << endl;
   cout << "getMinimum: " << stringTree.getMinimum() << endl;
   cout << "getHeight: " << stringTree.getHeight() << endl;
   cout << "getSize: " << stringTree.getSize() << endl;
   cout << "inorder: " << endl;
   stringTree.inorder(cout);
   cout << "preorder: " << endl;
   stringTree.preorder(cout);
   cout << "postorder: " << endl;
   stringTree.postorder(cout);
   cout << endl;  //blank line

    //display the graphic for stringTree
   cout << "Displaying the Graphic for stringTree: \n";
   stringTree.displayGraphic(cout);

    //copy stringTree to copiedStringTree and display the graphic
   cout << "\nCopying stringTree to copiedStringTree and displaying: " << endl;
   copiedStringTree = stringTree;
   copiedStringTree.displayGraphic(cout);

   //fill stringTree with characters
   ...
   stringTree.insert("I");
   stringTree.insert("Want");
   stringTree.insert("100");
   stringTree.insert("On");
   stringTree.insert("This");
   stringTree.insert("Project");

   //Test stringTree after it is filled
   cout << "Testing stringTree after it is filled.  It should be empty. \n";
   cout << "getMaximum: " << stringTree.getMaximum() << endl;
   cout << "getMinimum: " << stringTree.getMinimum() << endl;
   cout << "getHeight: " << stringTree.getHeight() << endl;
   cout << "getSize: " << stringTree.getSize() << endl;
   ...
   //insert more strings before and after previous values, and re-test
   stringTree.insert("Now");
   stringTree.insert("We");
   stringTree.insert("Will");
   stringTree.insert("Re-test");
   stringTree.insert("This");
   stringTree.insert("String");
   ...
   //Search for the string "We" in the stringTree variable
   cout << "Testing search function.  Find 'We': " << endl;
   if (stringTree.search("We")){
      cout << "Found 'We'!\n";
   }
   else {
      cout << "Not found. :(\n";
   }
   //Search for the string 'Hi' in the stringTree variable
   cout << "Now find 'Hi;: " << endl;
   if (stringTree.search("Hi")){
      cout << "Found 'Hi'!\n";
   }
   else {
      cout << "Not found. :(\n";
